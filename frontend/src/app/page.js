      ...
      <div className={styles.homePage}>
        <div className={styles.homePageContent}>
          <div className={styles.header}>
            ...
            <h2>This is a student project with the only purpose being academic work</h2>
            <Link
          ...
          <p>
            ...
            fail to account for individual variations such as muscle mass, bone density,
            and overall body composition. Machine learning models, on the other hand,
            can learn from large datasets containing diverse population samples to
            discern patterns and predictors of obesity that go beyond simple height and
            weight measurements.
          </p>
          <p>
            Utilizing machine learning for obesity detection makes sense because it
            allows for the incorporation of complex and nonlinear relationships between
            various predictors and obesity outcomes. These models can adapt and improve
            over time as they are fed more data, making them more robust and accurate.
            The ability to analyze vast arrays of data quickly and efficiently means
            that machine learning models can provide insights and diagnostic precision
